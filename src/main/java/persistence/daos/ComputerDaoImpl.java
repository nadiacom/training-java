...
public class ComputerDaoImpl implements ComputerDao {
    ...
    @Override
    public List<Computer> getPageListNameOrderBy(int page, int nbComputerByPage, String name, String columnName, String orderBy) throws DAOException {
